...
// <SANITIZE>
// Note: this overlay is used anytime a native close button and/or timer are needed, so
// the video nomenclature is kind of weird. It's worth reconsidering naming when moving
// to Swift.
// </SANITIZE>
