...
// <SANITIZE>
// Use the struct directly once all code using this file has moved to Swift
// </SANITIZE>
...
public class ImageCreativeData: NSObject {
    ...
    private struct ImageCreativeDataStruct: Codable {
        ...
        // <SANITIZE>
        // TODO: Combine with other server keys when other server handling has
        // been moved to Swift and codable structs
        // </SANITIZE>
